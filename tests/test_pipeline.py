...
SOURCE_DBS = ("db-changelogs", "db-blogs")
...
def test_poll_all_sources_survives_a_broken_feed(mocker):
    ...
    notion = mocker.Mock()
    notion.list_sources.side_effect = lambda db: [bad] if db == SOURCE_DBS[0] else []
